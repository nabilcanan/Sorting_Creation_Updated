...
class ExcelSorter:
    ...
    def create_widgets(self, frame):
        ...
        ttk.Button(frame, text="Run Queries", command=self.new_function, style="TButton").pack(pady=10)
    ...
    def click_button_image(self, image_path, confidence=0.8, offset=0, double_click_required=False):
        try:
    ...
    def new_function(self):
        ...
        def handle_save_changes_prompt():
            try:
                ...
                time.sleep(2)
                self.click_button_image(image_path_no_button)
        ...
        def login_and_run_query(query, where_to_click_image):
            ...
            self.click_button_image(image_path_criteria)

            # Click on specified "where to click" image (either WHERETOCLICKIMG1.png or WHERETOCLICKIMG2.png)
            self.click_button_image(where_to_click_image, offset=50, double_click_required=True)  # <-- Updated line
            ...
            def click_run_to_excel():
                ...
                if not run_to_excel_clicked:
                    ...
                    self.click_button_image(image_path_run_to_excel)
